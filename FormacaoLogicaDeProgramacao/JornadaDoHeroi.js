class HeroJourney {
    constructor(posicaoInicial, totalPassos) {
        this.posicaoInicial = posicaoInicial;
        this.totalPassos = totalPassos;
    }

    calcularPosicaoFinal() {
        return this.posicaoInicial + this.totalPassos;
    }
}
...
const jornadaHeroi = new HeroJourney(posicaoInicial, totalPassos);
const posicaoFinal = jornadaHeroi.calcularPosicaoFinal();
